...
{
    public static class StripePaymentWebhook
    {
        ...
        public static async Task<IActionResult> Run(
            ...
            ILogger log)
        {
            log.LogInformation("StripePaymentWebhook function processed a request.");
            ...
            try
            {
                var stripeEvent = EventUtility.ConstructEvent(
                    ...
                    StripeService.LiveWebhookSigningKey
                );

                StripeConfiguration.ApiKey = StripeService.LiveWebhookSigningKey;
                ...
                switch (stripeEvent.Type){
                    ...
                    case Events.InvoiceFinalized:
                        ...
                        StripeService.SetAutomaticCollectionForInvoice(invoice.Id);
