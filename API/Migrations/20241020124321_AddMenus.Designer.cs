...
namespace API.Migrations
{
    ...
    [Migration("20241020124321_AddMenus")]
            ...
            modelBuilder.Entity("Project.Function.Menu", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 10, 20, 12, 43, 21, 766, DateTimeKind.Utc).AddTicks(4431));
            ...
            modelBuilder.Entity("Project.Function.MenuItem", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 10, 20, 12, 43, 21, 766, DateTimeKind.Utc).AddTicks(4944));
